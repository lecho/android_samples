...
public class RootShell2 {
    ...
    private static final String EXIT = "exit" + RootShell2.EOL;
            ...
            try {
                ...
                if ((line = reader.readLine()) != null) {
                    ...
                    while ((line = reader.readLine()) != null) {
                        mBuffer.append(RootShell2.EOL).append(line);
                    }
                }
            } catch (IOException e) {
                e.printStackTrace();
    ...
    private static String suExec(String cmd) throws ShellException {
        try {
            ...
            shell.writeBytes(cmd + RootShell2.EOL);
            shell.flush();
            shell.writeBytes(RootShell2.EXIT);
            shell.flush();
            proc.waitFor();
            return buffer.getOutput();
    ...
    private static boolean isRootUid() throws ShellException {
        for (UID_COMMAND uid : UID_COMMAND.values()) {
            String output = RootShell2.sudo(uid.getCommand());
     ...
     */
    synchronized public static void setOutputStream(RootShell2.OUTPUT ostream) {
        sOStream = ostream;
    }
    ...
    synchronized public static String exec(String cmd) throws ShellException {
        return RootShell2.nativeExec(cmd);
    }
}
